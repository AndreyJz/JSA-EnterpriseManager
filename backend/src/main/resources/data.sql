...
-- CREACIÓN DE ROLES
INSERT INTO role (name) VALUES ('CUSTOMER'); --Buy Supplies and Services, LOGIN(without branch), Order/OrderStatus(if it isn't approved Write Why?)
INSERT INTO role (name) VALUES ('ADMINISTRATOR');
INSERT INTO role (name) VALUES ('BOSS'); --Work Orders
INSERT INTO role (name) VALUES ('EMPLOYEE'); --Work Orders/Orders(Which he is in charge), ApprovalStatus(Requested by Customer), Create Order(ask customer),
INSERT INTO role (name) VALUES ('SERVICE TRACKING'); --LIST Services that haven't been set to a branch
INSERT INTO role (name) VALUES ('MARKETING'); --LIST People
INSERT INTO role (name) VALUES ('BUYS DEPARTMENT'); --LIST Person_Supply(ONLY whose things have been bought),
INSERT INTO role (name) VALUES ('HUMAN RESOURCES'); -- ALL People(asigne Branch) Order and Work Order
INSERT INTO role (name) VALUES ('WAREHOUSE´S ADMIN'); --ALL Supplies, SellStatus, OrderStatus, SuppliesOrders, LIST Buys/Sells, LIST People(SUPPLIERS)
INSERT INTO role (name) VALUES ('STORAGE´S ADMIN'); --Buy Supplies, Manage Sells and Buys, Persons(Suppliers) PersonSupply
INSERT INTO role (name) VALUES ('SUPPLIERS'); --Buys, LIST buys,
